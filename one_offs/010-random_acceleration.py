...
def draw():
    ...
    # Pull in the ball variable
    global ball

    # Add a random unit vector as acceleration
    ball.add_force(Vector.random_2D())

    # Update the position of the ball, check its edges, and draw it on the
    # canvas.
    ball.step()
    ball.check_edges()
    ball.show()
